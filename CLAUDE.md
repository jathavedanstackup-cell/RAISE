...
- When a checkpoint touches design/UI, use the installed `design:*` skills (accessibility-review, design-critique, ux-copy, design-handoff, design-system) — see `docs/concept-critique.md` and `docs/accessibility-audit.md` for what's already been found on this product's concept screens; don't rediscover those issues from scratch.
